...
async def consult_citizen_inquiry_agent(user_query: str, state: Annotated[dict, InjectedState]) -> str:
    ...
    Use this when the citizen asks something OUTSIDE permits and licensing
    (e.g. tax/assessment payments, welfare benefits and eligibility, health and
    environmental permits, civil registration/records requests).

    Args:
        user_query: The citizen's out-of-scope question, forwarded as-is.
    """
