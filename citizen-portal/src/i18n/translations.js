...
export const translations = {
  en: {
    ...
    serviceGrid: {
      ...
      subtitle: '5 departments, each with a dedicated AI assistant',
      categories: [
        { id: 'contact-center', title: 'Contact Center', description: 'General inquiries and service directory.' },
        { id: 'social', title: 'Social Services', description: 'CalFresh, CalWORKs, Medi-Cal, IHSS, General Relief.' },
        { id: 'permits', title: 'Permits & Licensing', description: 'Building permits and business licenses.' },
        { id: 'tax', title: 'Tax & Revenue', description: 'Assessment rates and property tax payments.' },
        { id: 'records', title: 'Records & Compliance', description: 'Vital records and public records requests.' },
      ],
    },
    gazette: {
    ...
    chat: {
      ...
      close: 'Close',
      openChat: 'Open chat',
      liveModeNotice: 'Live mode — connected to Agent Manager',
    ...
    social: {
      ...
      tryAsJoan: 'Try asking as Joan Ellis: "Summarize case CASE-1004" — assigned to Renee Alvarez — to see the access-denied security notice.',
    },
    permits: {
    ...
    agents: {
      ...
      citizenInquiryPermits: { name: 'Citizen Inquiry Agent', department: 'Riverside County Permits & Licensing' },
      welfareEligibility: { name: 'Citizen Inquiry Agent', department: 'Riverside County Department of Social Services' },
      planningPermits: { name: 'Citizen Inquiry Agent', department: 'Riverside County Permits & Licensing' },
      taxRevenueAssistant: { name: 'Citizen Inquiry Agent', department: 'Riverside County Tax & Revenue' },
      recordsFoiaBrand: { name: 'Citizen Inquiry Agent', department: 'Riverside County Records & Compliance' },
      benefitsEligibility: { name: 'Citizen Inquiry Agent', department: 'Riverside County Department of Social Services' },
    ...
    pages: {
      home: {
        ...
        deptDirectorySub: '3 Agent Kinds · 8 running instances',
    ...
    services: {
      ...
      'senior-allowance': { title: 'IHSS (In-Home Supportive Services)', description: 'In-home caregiving support for aged, blind, or disabled residents.' },
      'medical-aid': { title: 'Medi-Cal', description: 'Free or low-cost health coverage.' },
      'public-assistance': { title: 'CalFresh / CalWORKs / General Relief', description: 'Food benefits, cash aid, and Welfare-to-Work.' },
      'building-plan': { title: 'Building Permit Approval', description: 'Submit and track building/ADU/solar/pool permit applications.' },
      'street-line': { title: 'Fee Schedule Lookup', description: 'Estimate fees for any permit type.' },
      'trade-license': { title: 'Business License', description: 'Register and renew a business license.' },
      ...
      'foia-request': { title: 'Public Records Request', description: 'Submit a California Public Records Act (CPRA) request.' },
    ...
    quickReplyLabels: {
      ...
      'List my current cases': 'List my current cases',
      'Summarize case CASE-1001': 'Summarize case CASE-1001',
      'Add a note to case CASE-1003': 'Add a note to case CASE-1003',
      'Check status for permit BP-2026-00042': 'Check status for permit BP-2026-00042',
      'What would an ADU permit cost for a $90,000 project?': 'What would an ADU permit cost for a $90,000 project?',
      'Check status for business license BL-2026-00012': 'Check status for business license BL-2026-00012',
      'What is the annual fee for a business license?': 'What is the annual fee for a business license?',
