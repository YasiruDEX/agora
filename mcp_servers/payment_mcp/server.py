...
def _resolve_db_path() -> Path:
    """Configurable via TAX_DB_PATH (same env var mcp_servers/tax_db_mcp/server.py
    reads) so both stay pointed at the same file even when bundled standalone
    alongside a single agent, without the rest of the monorepo."""
